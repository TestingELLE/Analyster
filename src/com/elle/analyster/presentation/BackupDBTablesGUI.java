 ...
 * @author Carlos
 */
public class BackupDBTablesGUI extends javax.swing.JFrame {

    /**
     * Creates new form BackupDBTablesGUI
     */
    public BackupDBTablesGUI() {
        initComponents();
        ...
        //jList1 = checkBoxList;
        //jList1.setListData(checkBoxItems.toArray());
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BackupDBTablesGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BackupDBTablesGUI().setVisible(true);
            }
        });
    }
